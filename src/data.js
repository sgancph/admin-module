...
export const leads = {
  1: {
    ...
    createdAt: new Date(),
    lifecycleStages: [
      { lifecycleStage: "Assigned", start: "xx", end: "yy", duration: "zz" },
      {
        lifecycleStage: "Successful Contact",
        start: "xx",
        end: "yy",
        duration: "zz",
      },
      {
        lifecycleStage: "Appointment Fixed",
        start: "xx",
        end: "yy",
        duration: "zz",
        isActive: true,
      },
      { lifecycleStage: "Prospecting", start: "xx", end: "yy", duration: "zz" },
      {
        lifecycleStage: "Application Submitted",
        start: "xx",
        end: "yy",
        duration: "zz",
      },
      {
        lifecycleStage: "Sales Closed",
        start: "xx",
        end: "yy",
        duration: "zz",
      },
  ...
  2: {
    ...
    createdAt: new Date(),
    lifecycleStages: [
      { lifecycleStage: "Assigned", start: "xx", end: "yy" },
      { lifecycleStage: "Successful Contact", start: "xx", end: "yy" },
      {
        lifecycleStage: "Appointment Fixed",
        start: "xx",
        end: "yy",
      ...
      { lifecycleStage: "Prospecting", start: "xx", end: "yy" },
      { lifecycleStage: "Application Submitted", start: "xx", end: "yy" },
...
export const lifecycleStageOptions = [
  ...
  { value: 2, label: "Successful Contact" },
  { value: 3, label: "Appointment Fixed" },
  { value: 4, label: "Prospecting" },
  { value: 5, label: "Application Submitted" },
  { value: 6, label: "Sales Closed" },
];
